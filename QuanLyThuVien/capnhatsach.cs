...
namespace QuanLyThuVien
{
    public partial class capnhatsach : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'libraryDataSet.tblSach' table. You can move, or remove it, as needed.
            this.tblSachTableAdapter.Fill(this.libraryDataSet.tblSach);
